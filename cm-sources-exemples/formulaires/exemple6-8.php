<!DOCTYPE html> <html lang="fr">
 <head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /> <title>Calculatrice en ligne</title>
 </head> 
 <body>
 <!-- Code PHP -->
<?php 
if(isset($_POST["calcul"])&&isset($_POST["nb1"])&&isset($_POST["nb2"])) 
{
 ...
 {
  case "Addition x+y":
  $resultat= $_POST["nb1"]+$_POST["nb2"]; break;
  case "Soustraction x-y":
  $resultat= $_POST["nb1"]-$_POST["nb2"]; break;
  case "Division x/y":
  $resultat= $_POST["nb1"]/$_POST["nb2"]; break;
  case "Puissance x^y":
  $resultat= pow($_POST["nb1"],$_POST["nb2"]); break;
 }
} 
else
{
...
<tr>
<th>Résultat </th>
<td> <input type="number" step="0.5" name="result" size="30" value="<?php if(isset($resultat)) echo $resultat;else echo''?>"/>
</td>
</tr> 
<tr>
<th>Choisissez !</th> 
